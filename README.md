...
## Machine Learning
  ...
  * Also did a linear regression model but the Rsquared was 0.8813022659817239. However, when we removed the unnecessary coefficients the R-squared was 0.8778153484778893 which shows very little change. 
